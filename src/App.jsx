      ...
      <div className=" p-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
          ...
          <div className="flex items-center">
              <img src="public/img/html_image.png" alt="" className="w-4 h-auto rounded-sm mr-2" />
          ...
          <div className="bg-[#282c34] p-4 rounded-lg shadow">
          <div className="flex items-center">
              <img src="public/img/css_image.jpg" alt="" className="w-5 h-5 rounded-sm mr-2" />
          ...
          <div className="bg-[#282c34] p-4 rounded-lg shadow">
          <div className="flex items-center">
              <img src="public/img/js_image.png" alt="" className="w-4 h-auto rounded-sm mr-2" />
